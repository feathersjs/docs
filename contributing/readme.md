...
You'll notice that the [GitHub Repo](https://github.com/feathersjs/docs) is organized in a nice logical folder structure.  The first file in each chapter is named as a description of the entire chapter's topic.  For example, the content related to databases is located in `api/databases/`. 
...
You'll find the table of contents in the [SUMMARY.md](https://github.com/feathersjs/docs/blob/master/SUMMARY.md) file.  It's a nested list of markdown links.  You can link to a file simply by putting the filename (including the extension) inside the link target.

### Introduction Page

This is the root [README.md](https://github.com/feathersjs/docs/blob/master/README.md) file. It's intent is to give the reader an elevator pitch of what Feathers is and why we think it is useful.
