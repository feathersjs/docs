...
- The [feathers-authentication](#feathers-authentication) plugin and its accompanying [strategies](./strategies.md) help add JSON Web Token (JWT)-based authorization to your app.
- The [feathers-permissions](./permissions.md) plugin provides a set of hooks for controlling authorization.
