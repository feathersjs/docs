...
Have a look a the example at [feathersjs.com](https://feathersjs.com/), the [real-time basics guide](../guides/basics/real-time.md) and the [channels documentation](../api/channels.md).
