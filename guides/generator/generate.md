...
The Feathers CLI and generator should be installed globally by running
...
Which should show a version of `3.2.1` or later.
...
The generator creates some modules reflecting your choices.

They are mostly [boilerplate](https://en.wikipedia.org/wiki/Boilerplate_code) and organized as follows:
